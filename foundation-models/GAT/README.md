...
This directory contains a complete implementation of the GAT architecture as part of the 120-day deep learning journey.
...
- [ ] Implement GAT architecture in `models/gat.py`
- [ ] Set up proper data loading in `data/data_module.py`
- [ ] Configure hyperparameters in `config/config.py`
- [ ] Add evaluation metrics specific to GAT
- [ ] Create comprehensive tests
- [ ] Add documentation and examples

## References

- TODO: Add relevant papers and resources for GAT
