...
This directory contains a complete implementation of the PointNet architecture as part of the 120-day deep learning journey.
...
- [ ] Implement PointNet architecture in `models/pointnet.py`
- [ ] Set up proper data loading in `data/data_module.py`
- [ ] Configure hyperparameters in `config/config.py`
- [ ] Add evaluation metrics specific to PointNet
- [ ] Create comprehensive tests
- [ ] Add documentation and examples

## References

- TODO: Add relevant papers and resources for PointNet
